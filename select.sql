...
select student.id, student.name, avg(score) from student inner join student_course where student.id=student_course.studentid group by student.id having avg(score)>=60
